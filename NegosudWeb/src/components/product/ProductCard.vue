        ...
        computed: {
            filteredFamilles() {
                ...
                if (this.selectedFilters) {
                    if (this.selectedFilters.fournisseurs && this.selectedFilters.fournisseurs.length > 0) {
                        filteredFamilles = filteredFamilles.filter(famille => this.selectedFilters.fournisseurs.includes(famille.fournisseurs.nom));
                    }
                }
