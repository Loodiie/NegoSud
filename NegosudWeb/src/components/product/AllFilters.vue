    ...
    <div class="accordion" id="accordionPanelsStayOpenExample">
        <div class="accordion-item">
            ...
            <div id="panelsStayOpen-collapseOne" class="accordion-collapse collapse show" aria-labelledby="panelsStayOpen-headingOne">
                <div class="accordion-body">
                    <ul>
                        <li v-for = "fournisseur in fournisseurs" v-bind:key = "fournisseur.id" class="list-group-item">
                            <input class="form-check-input me-1" type="checkbox" v-model = "selectedFournisseurs" :value="fournisseur.nom" @change="selectedFournisseurs">
                            {{ fournisseur.nom }}
                        </li>
                    </ul>
                </div>
        ...
        <div class="accordion-item">
            ...
            <div id="panelsStayOpen-collapseTwo" class="accordion-collapse collapse show" aria-labelledby="panelsStayOpen-headingTwo">
                <div class="accordion-body">
                    <ul>
                        <li v-for = "typeVin in uniqueTypeVin" v-bind:key = "typeVin" class="list-group-item">
        ...
        <div class="accordion-item">
            ...
            <div id="panelsStayOpen-collapseTwo" class="accordion-collapse collapse show" aria-labelledby="panelsStayOpen-headingTwo">
                <div class="accordion-body">
                    <ul>
                        <li v-for = "annees in uniqueAnnee" v-bind:key = "annees" class="list-group-item">
                            <input class="form-check-input me-1" type="checkbox" value="" aria-label="...">
                            {{ annees }}
                        </li>
                    </ul>
    ...
    export default {
        ...
        methods: {
            ...
            getUniqueTypeVin() {
                ...
                this.uniqueTypeVin.sort((a, b) => a - b);
            },
            filterFournisseurs() {
