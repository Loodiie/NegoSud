        ...
        <div class="container-fluid">
            <div class="col-md-5 collapse navbar-collapse" id="navbarNavDropdown">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="/allproducts">Nos produits</a>
                    </li>
                    <li class="nav-item">
            ...
            <div class="col-md-3 d-flex justify-content-around">
                ...
                <a href = "/connexion" type="button" class="btn btn-outline-danger">Se connecter</a>
            </div>
        </div>
    </nav>

    <div class="col-11 min-vh-100 mx-auto">
        <div class="container-fluid d-flex flex-column align-items-center justify-content-center">
            <h2 class="text-center mb-4">Résultats de la recherche pour "{{ searchTerm }}"</h2>
            <div class="row row-cols-1 row-cols-md-5 g-4">
                <div v-if="filteredFamilles.length === 0" class="text-center">
                    <p>Aucun résultat trouvé.</p>
                </div>
                <div v-else v-for="famille in filteredFamilles" :key="famille.id" class="col">
    ...
    computed: {
        filteredFamilles() {
            return this.Familles.filter(famille => {
                return famille.libelle.toLowerCase().includes(this.searchTerm.toLowerCase());
            });
        }
    },
    methods: {
        async loadFamilles() {
            try {
                const response = await FamillesService.getFamillesBySearch(this.searchTerm);
        ...
        search() {
            this.$router.push({ name: 'SearchResultView', params: { searchTerm: this.searchTerm } });
        }
    },
    created() {
        this.loadFamilles();
