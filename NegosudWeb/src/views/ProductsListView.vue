    ...
    <div class="container-fluid">
      <div class="row mb-4">
        ...
        <div class="row">
          ...
          <div class="d-flex flex-row flex-md-col">
            <div class="mb-3 mb-md-1">
              <button class="btn btn-outline-dark" @click="sortByNameAsc">
                Trier par nom croissant
              </button>
              <button class="btn btn-outline-dark" @click="sortByNameDesc">
                Trier par nom décroissant
              </button>
              <button class="btn btn-outline-dark" @click="sortByPriceAsc">
                Trier par prix croissant
              </button>
              <button class="btn btn-outline-dark" @click="sortByPriceDesc">
            ...
            <div class="accordion-item col-3">
              <h2 class="accordion-header" id="panelsStayOpen-headingFive">
                <button
                  ...
                  style="background-color: darkgrey; color: #ffffff"
                >
                  Type vin
                </button>
              </h2>
                  ...
                  <ul>
                    ...
                    >
                      <input
                        ...
                        type="checkbox"
                        v-model="selectedTypeVin"
                        :value="typeVin.libelle"
                        @change="filterFamilles"
                      />
                      {{ typeVin.libelle }}
                    </li>
                  </ul>
            ...
            <div class="accordion-item col-3">
              ...
              >
                <div class="accordion-body">
                  ...
                  <button class="btn btn-primary" @click="filterFamilles">
                    OK
                  </button>
                </div>
              </div>
          ...
          <div class="d-flex flex-column align-items-center container-fluid">
            ...
            <div class="row row-cols-1 row-cols-md-4 g-4">
              <div
                ...
                typeVin in uniqueTypeVin &&
                fournisseur in uniqueFournisseurs"
                :key="famille.id && typeVin && fournisseur"
                class="col"
              >
                <div class="card h-100">
                  ...
                  <div class="card-body">
                    <h5 class="card-title">
                      ...
                      {{ famille && famille.famille_id }}
                    </h5>
                    <p class="card-text">
                      {{
                        famille &&
                        famille.fournisseur &&
                        famille.fournisseur.nom
                      }}
                    </p>
...
export default {
      ...
      if (
        ...
        filteredFamilles = filteredFamilles.filter((famille) => {
          ...
          if (this.minPrice !== null && this.maxPrice !== null) {
            priceCondition =
              famille.prix_unit >= this.minPrice &&
              famille.prix_unit <= this.maxPrice;
          }

          let fournisseursCondition = true;
          if (this.selectedFournisseurs.length > 0) {
            fournisseursCondition = this.selectedFournisseurs.includes(
              famille.fournisseur.nom
            );
          }
          ...
          if (this.selectedTypeVin.length > 0) {
            typeVinCondition = this.selectedTypeVin.includes(
              famille.typeVin.libelle
            );
          }

          return (
            priceCondition &&
            fournisseursCondition &&
            anneeCondition &&
            typeVinCondition
          );
        });
  ...
  methods: {
    ...
    async getUniqueFournisseurs() {
      ...
      this.uniqueFournisseurs = (
        await FournisseursService.getFournisseurs()
      ).data;
    },
    filterFamilles() {
